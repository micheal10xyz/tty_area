...
const COLLECTION_NAMES = ['categories', 'services', 'submissions', 'feedbacks', 'adminConfig']
...
async function initBootstrap() {
  ...
  // 集合不存在时自动创建（分类/服务/提交/反馈/管理员配置）
  await ensureCollections()

  const result = { categoriesInserted: 0, servicesInserted: 0 }
